...
<head>
  ...
  width: 100%;
  height: 10px;
  background: #ff5200; /* Modification de la couleur de fond */
  position: absolute;
  bottom: -10px;
  left: 0;
  display: block;
            ...
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="Accueil.php">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar" style="margin-top: 19px;">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link" href="Demandes%20d_essai.php"><i class="far fa-comments" style="color: var(--bs-accordion-bg);"></i><span>Demandes d'essai</span></a>
            ...
            <div id="content">
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4" style="margin-bottom: 25px;margin-top: 30px;">
                        <h3 class="text-dark mb-0">Accueil&nbsp; ADMIN</h3>
                    </div>
                </div>
                <div class="container-fluid py-5">
                    <div class="row">
                    <div class="col-md-6 mb-lg-0" style="padding: 10px;margin-top: -65px;">
                            <div class="hover hover-5 text-white rounded"><img src="https://res.cloudinary.com/mhmd/image/upload/v1570786269/hoverSet-10_ccl30n.jpg" alt="image">
                                <div class="hover-overlay" style="background: url(&quot;assets/img/Lambo.jpg&quot;);background-size: cover;"></div>
