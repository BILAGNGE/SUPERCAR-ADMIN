...
if ($stmt->execute()) {
    // Vérifiez si le prix a été ajusté (en fonction de la variable de session)
    if (isset($_SESSION['price_adjusted']) && $_SESSION['price_adjusted'] == 1) {
        echo '<div class="alert alert-warning" role="alert">Le prix a été ajusté pour respecter la limite de 25% d\'augmentation.</div>';
        // Unset la variable de session
        unset($_SESSION['price_adjusted']);
    }
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                <div class="container-fluid">
                    <h3 class="text-dark mb-1" style="margin-top: 20px; margin-left: 30px;">Modification</h3>
